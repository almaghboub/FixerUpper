...
const resources = {
  en: {
    translation: {
      ...
      itemsExchangeRate: "Items Exchange Rate (LYD)",
      shippingExchangeRate: "Shipping Exchange Rate (LYD)",
      lockedAtCreation: "Locked at order creation",
      originalRateFromCreation: "Original rate from creation",
      enterShippingExchangeRate: "Current shipping rate",
      shippingRateEditable: "Used for shipping cost calculation",
      ...
      orderCodeAutoGenerated: "Auto-generated based on country (e.g., UK0001, SH0001)",
      ...
      uploadImagesInOrders: "Upload images when creating or editing orders",
  ...
  ar: {
    translation: {
      ...
      itemsExchangeRate: "سعر صرف السلع (دينار ليبي)",
      shippingExchangeRate: "سعر صرف الشحن (دينار ليبي)",
      lockedAtCreation: "مقفل عند إنشاء الطلب",
      originalRateFromCreation: "السعر الأصلي من الإنشاء",
      enterShippingExchangeRate: "سعر الشحن الحالي",
      shippingRateEditable: "يستخدم لحساب تكلفة الشحن",
      ...
      orderCodeAutoGenerated: "يتم توليده تلقائياً بناءً على البلد (مثال: UK0001, SH0001)",
      ...
      uploadImagesInOrders: "قم برفع الصور عند إنشاء أو تعديل الطلبات",
